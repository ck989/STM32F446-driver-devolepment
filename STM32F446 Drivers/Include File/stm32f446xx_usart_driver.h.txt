...
/*
 * this is a configuration for USART pin
 */
...
/*
 * this is a structure handle for USART pin
 */

typedef struct
{
	USART_RegDef_t *pUSARTx;            //this holds the address of the USART pin which it belongs to.
	USART_PinConfig_t USART_PinConfig;  //this holds USART configuration settings.
	uint8_t         *pTxBuffer;
	uint8_t         *pRxBuffer;
	uint32_t         TxLen;
	uint32_t         RxLen;
